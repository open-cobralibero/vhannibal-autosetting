...
class MenuiSettingE2(Screen, ConfigListScreen):
	...
	def hauptListEntryMenuB(self, name, date, link, name1, date1):
		...
		if HD.width() == 2560:
			...
			res.append(MultiContentEntryText(pos=(15, 0), size=(650, 40), font=0, text=name, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
			res.append(MultiContentEntryText(pos=(680, 0), size=(400, 40), font=0, text=date1, color=0xFFFFFF, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
			res.append(MultiContentEntryText(pos=(0, 0), size=(0, 0), font=0, text=link, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
